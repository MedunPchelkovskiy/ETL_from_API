...
from src.workers.gold.load_gold_data import load_gold_data_to_azure_worker, load_gold_data_to_postgres_worker
...
def load_gold_data_to_postgres(data):
    logger = get_logger()
    ...
    load_gold_data_to_postgres_worker(data, engine)
