...
from validation.scraped_data.accuweather_input_data_validation import validate_input_accuweather_data
from validation.scraped_data.accuweather_output_data_validation import validate_output_accuweather_data
from validation.scraped_data.meteoblue_input_data_validation import validate_meteoblue_input_data
from validation.scraped_data.meteoblue_output_data_validation import validate_meteoblue_output_data
from validation.scraped_data.sinoptik_input_data_validation import validate_input_sinoptik_data
from validation.scraped_data.sinoptik_output_data_validation import validate_output_sinoptik_data
